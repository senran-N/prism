...
export default function Dashboard() {
  const { t } = useLocale();
  const [tab, setTab] = useState<"tasks" | "github">("tasks");
  ...
  return (
    <div className="flex h-[calc(100vh-53px)]">
      <aside className="w-[280px] bg-white border-r border-[#e3e8ee] flex flex-col">
        ...
        {tab === "tasks" ? <TaskList tasks={tasks} activeTask={activeTask} onSelect={setActiveTask} /> : <GitHubPanel />}
      </aside>
