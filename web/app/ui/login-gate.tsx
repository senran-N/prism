    ...
    <div className="min-h-screen bg-[#f6f9fc] flex items-center justify-center">
      <div className="bg-white rounded-2xl border border-[#e3e8ee] p-8 w-full max-w-sm text-center" style={{ boxShadow: "0 4px 24px rgba(0,0,0,0.06)" }}>
        ...
        <a href="/api/linuxdo/login"
          className="flex items-center justify-center gap-2.5 w-full bg-[#f39c12] hover:bg-[#e67e22] text-white rounded-lg px-4 py-3 text-[14px] font-medium transition-colors mb-3"
        ...
        <a href="/api/github/login"
          className="flex items-center justify-center gap-2.5 w-full bg-[#0a2540] hover:bg-[#1a3550] text-white rounded-lg px-4 py-3 text-[14px] font-medium transition-colors"
